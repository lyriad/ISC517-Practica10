...
<#macro title>${action} Category</#macro>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="col-sm-12 mb-3 mb-sm-3">
                ...
                <input name="name" type="text" class="form-control form-control-user <#if (errors.name)??>is-invalid</#if>" placeholder="Category name" value="<#if (category.name)??>${category.name}</#if>" >
